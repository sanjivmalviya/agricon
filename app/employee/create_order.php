<?php
   ...
   if(isset($request->customer_id) && isset($request->consignee_same_as_customer) && isset($request->consignee) && isset($request->employee_id)){
         ...
         if(insert('tbl_orders',$form_data)){
            ...
            if(isset($request->order_detail)){
               ...
               foreach($request->order_detail as $rs){
                  ...
                  $order_product_cgst = 0;
                  $order_product_sgst = 0;
                  $order_product_igst = 0;
                  ...
                  //    'order_dispatch_quantity' => $val->val,
                  ...
                  $insert_order_detail = "INSERT INTO tbl_order_detail(order_id,order_product_id,order_product_quantity,order_dispatch_quantity,order_product_rate,order_product_discount,order_product_cgst,order_product_sgst,order_product_igst) VALUES('$last_id','$rs->order_product_id','$rs->order_product_quantity','0','$rs->order_product_rate','$rs->order_product_discount','$order_product_cgst','$order_product_sgst','$order_product_igst')";

                  if(query($insert_order_detail)){
            ...
            if($insert == 0){
               ...
               $form_data = array(
                  ...
                  'customer_outstanding_type' => 2,

                  'customer_outstanding_amount' => $product_total,

                  'customer_outstanding_date' => date('Y-m-d', strtotime($timestamp))
