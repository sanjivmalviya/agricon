...
$invoices = getRaw("SELECT * FROM tbl_invoices WHERE order_id = '$order_id' AND godown_id = '$godown_id'");
              ...
              <tbody>
                ...
                <?php if(isset($invoices)){ ?>
                   ...
                   <!--      <td><?php echo $rs['invoice_delivery_note']; ?></td>
                        ...
                        <td class="text-right"><a href="invoice_detail.php?invoice_id=<?php echo $rs['invoice_id']; ?>" class="btn btn-primary btn-xs"><i style="font-size: 15px;" class="fa fa-print"></i> Print Invoice</a></td>
                      </tr>
