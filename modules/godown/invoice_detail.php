   ...
   <body class="fixed-left">
      ...
      <div id="wrapper">
         ...
         <div class="container">
          ...
          <a href="../../modules/godown/invoice.php?order_id=<?php echo $order_id; ?>" class="btn btn-sm btn-default"><i class="fa fa-angle-left" style="font-size: 20px;"></i></a>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6 col-xs-6">
                    ...
                    <div class="row text-left">
                        ...
                        <?php if(isset($invoice['consignee_same_as_customer']) && $invoice['consignee_same_as_customer']== 1)  { ?>     
                      ...
                      <?php }else{ ?>
                        ...
                        <div class="col-md-12 col-xs-12">
                          ...
                          <p> <?php if(isset($invoice['consignee'])){ echo $invoice['consignee']; }  ?> </p>
                          ...
                          <?php if(isset($order_detail)){ ?>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                ...
                                <?php echo $rs['dispatch_quantity']; ?></td>
