<?php
 ...
 $punchings = getRaw('SELECT * FROM tbl_staff_employee_routine ORDER BY routine_id DESC');
                           ...
                           <div class="row">
                                 ...
                                 <div class="col-md-6 text-right">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                      <a href="javascript:;" class="btn btn-secondary active">All</a>
                                      <a href="staff_punch_today.php" class="btn btn-secondary">Today</a>
                                    </div>
                                 </div>
